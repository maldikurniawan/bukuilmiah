    ...
    <div class="container-fluid">
        ...
        <div class="page-body">
            <div class="container-xl">
                <form action="{{ route('bookchapter.update', $bookchapter->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->judul_buku }}" id="judul_buku"
                                                    name="judul_buku"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->book_chapter }}"
                                                    id="book_chapter" name="book_chapter"
                                        ...
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->isbn }}" id="isbn"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->edisi }}" id="edisi"
                                                    name="edisi"
                                        ...
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->penerbit }}" id="penerbit"
                                                    name="penerbit"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->jml_halaman }}"
                                        ...
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                <label for="">URL</label>
                                                <input type="text" value="{{ $bookchapter->url }}" id="url"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->thn_terbit }}"
                                        ...
                                        <div class="col-6">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $bookchapter->jml_anggota }}"
